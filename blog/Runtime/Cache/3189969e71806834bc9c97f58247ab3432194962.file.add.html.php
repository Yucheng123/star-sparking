<?php /* Smarty version Smarty-3.1.6, created on 2015-09-29 16:35:31
         compiled from "D:/itcast/homework/TPframework/blog/Admin/View\Event\add.html" */ ?>
<?php /*%%SmartyHeaderCode:20102560a422e629b42-51939605%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3189969e71806834bc9c97f58247ab3432194962' => 
    array (
      0 => 'D:/itcast/homework/TPframework/blog/Admin/View\\Event\\add.html',
      1 => 1443515229,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20102560a422e629b42-51939605',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_560a422f35565',
  'variables' => 
  array (
    'cat_parent_infor' => 0,
    'v' => 0,
...
<?php if ($_valid && !is_callable('content_560a422f35565')) {function content_560a422f35565($_smarty_tpl) {?><!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<!-- 		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-2">
				<input type="text" class="input-text" value=" " placeholder="" id="" name="evt_title">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-2">
			<input type="text" onfocus="WdatePicker({ minDate:'#F{ $dp.$D(\'logmin\')}',maxDate:'%y-%M-%d'})" id="logmax" class="input-text Wdate" name="evt_time" style="width:180px;">
			</div>
		</div>
<!-- 		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-10"> 
				<script id="editor" type="text/plain" style="width:100%;height:400px;" name = "evt_desc"></script> 
			</div>
		</div>
		<div class="row cl">
