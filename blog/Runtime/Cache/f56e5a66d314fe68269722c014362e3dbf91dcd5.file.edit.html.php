<?php /* Smarty version Smarty-3.1.6, created on 2015-09-26 20:53:47
         compiled from "D:/itcast/homework/TPframework/blog/Admin/View\Blog\edit.html" */ ?>
<?php /*%%SmartyHeaderCode:249005606365dc17cb0-68484880%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f56e5a66d314fe68269722c014362e3dbf91dcd5' => 
    array (
      0 => 'D:/itcast/homework/TPframework/blog/Admin/View\\Blog\\edit.html',
      1 => 1443271909,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '249005606365dc17cb0-68484880',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_5606365e9ac78',
  'variables' => 
  array (
    'blog_one_infor' => 0,
    'cat_parent_infor' => 0,
...
<?php if ($_valid && !is_callable('content_5606365e9ac78')) {function content_5606365e9ac78($_smarty_tpl) {?><!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
" method="post" class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			...
			<div class="formControls col-10">
				<input type="text" class="input-text" value="<?php echo $_smarty_tpl->tpl_vars['blog_one_infor']->value['blog_title'];?>
" placeholder="" id="" name="blog_title">
			</div>
		</div>
<!-- 		<div class="row cl">
...
"><?php echo $_smarty_tpl->tpl_vars['v']->value['cat_name'];?>
			...
			<div class="formControls col-2">
				<input type="text" class="input-text" value="<?php echo $_smarty_tpl->tpl_vars['blog_one_infor']->value['sort_by'];?>
" placeholder="" id="" name="sort_by">
		...
		<div class="row cl">
			...
			<div class="formControls col-10">
				<input type="text" class="input-text" value="<?php echo $_smarty_tpl->tpl_vars['blog_one_infor']->value['blog_keyword'];?>
" placeholder="" id="" name="blog_keyword">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-2">文章摘要：</label>
			<div class="formControls col-10">
				<textarea name="blog_abstract" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="textarealength(this,200)"><?php echo $_smarty_tpl->tpl_vars['blog_one_infor']->value['blog_abstract'];?>
</textarea>
		...
		<div class="row cl">
			...
			<div class="formControls col-1">
				<input type="text" class="input-text" value="<?php echo $_smarty_tpl->tpl_vars['blog_one_infor']->value['blog_author'];?>
" placeholder="" id="" name="blog_author">
			</div>
			...
			<div class="formControls col-4">
				<input type="text" class="input-text" value="<?php echo $_smarty_tpl->tpl_vars['blog_one_infor']->value['blog_source'];?>
" placeholder="" id="" name="blog_source">
			</div>
...
<!-- 		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-10"> 
				<script id="editor" type="text/plain" style="width:100%;height:400px;" name = "blog_text"><?php echo $_smarty_tpl->tpl_vars['blog_one_infor']->value['blog_text'];?>
</script> 
			</div>
		</div>
		<div class="row cl">
			<div class="col-10 col-offset-2">
				<button onClick="return article_save_submit();" class="btn btn-primary radius" type="submit"><i class="Hui-iconfont">&#xe632;</i> 保存并提交审核</button>
...
<script type="text/javascript">
	$('[name = "is_self"]').css("width", "80px");
	$('[name = "is_self"]').css("height", "30px");
	$('[name = "is_self"]').css("font-size", "15px");
</script>
<script type="text/javascript">
$(function(){
	//这里应该是设置获得焦点时出现光晕的
...
function article_save_submit(){
	$("#form-article-add").append($('<input type="hidden" name="is_finished" value="1">'));
	$("#form-article-add").submit();
	return false;
}
</script>
...
<script type ="text/javascript">
	//处理精选的选择
		<?php if ($_smarty_tpl->tpl_vars['blog_one_infor']->value['is_best']=="1"){?>
		$("[name='is_best']").attr("checked","checked");
		<?php }?>
	//显示文章类型
		$("[name='is_self']").val("<?php echo $_smarty_tpl->tpl_vars['blog_one_infor']->value['is_self'];?>
");
	//显示二级联动菜单中首联的选中
		$("[name ='cat_parent']").val("<?php echo $_smarty_tpl->tpl_vars['parent_id']->value;?>
");
	//显示二级联动菜单中第二联的选中
		$("[name ='cat_id']").val('<?php echo $_smarty_tpl->tpl_vars['blog_one_infor']->value["cat_id"];?>
');
	//图片上传的显示，如果已经有封面图片了，上传将覆盖原图
		$list = $("#fileList")
		<?php if (!empty($_smarty_tpl->tpl_vars['blog_one_infor']->value["blog_img"])){?>
			$li = $(
			'<div class="item>' +
