<?php /* Smarty version Smarty-3.1.6, created on 2015-10-02 13:14:54
         compiled from "D:/itcast/homework/TPframework/blog/Admin/View\Picture\add.html" */ ?>
<?php /*%%SmartyHeaderCode:796056092317c41fe9-28996343%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd099fa9331c6c46c320236dd68137d0c4097e1ec' => 
    array (
      0 => 'D:/itcast/homework/TPframework/blog/Admin/View\\Picture\\add.html',
      1 => 1443701539,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '796056092317c41fe9-28996343',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_5609231895728',
  'variables' => 
  array (
    'cat_parent_infor' => 0,
    'v' => 0,
...
<?php if ($_valid && !is_callable('content_5609231895728')) {function content_5609231895728($_smarty_tpl) {?><!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
" method="post" class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			...
			<div class="formControls col-10">
				<input type="text" class="input-text" value="" placeholder="" id="" name="pic_title">
			</div>
		</div>
		<!-- div class="row cl">
...
"><?php echo $_smarty_tpl->tpl_vars['v']->value['cat_name'];?>
		...
		<div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>文类型：</label>
			<div class="formControls col-2"> 
			...
			<div class="formControls col-2">
				<input type="text" class="input-text" value="0" placeholder="" id="" name="pic_author">
			</div>
			<label class="form-label col-2">图片来源：</label>
			<div class="formControls col-2">
				<input type="text" class="input-text" value="0" placeholder="" id="" name="pic_source">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-2">关键词：</label>
			<div class="formControls col-10">
				<input type="text" class="input-text" value="0" placeholder="" id="" name="pic_keyword">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-10">
				<textarea name="pic_desc" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="textarealength(this,200)"></textarea>
