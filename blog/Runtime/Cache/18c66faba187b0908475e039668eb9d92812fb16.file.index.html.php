<?php /* Smarty version Smarty-3.1.6, created on 2015-10-11 23:26:11
         compiled from "D:/itcast/homework/TPframework/blog/Admin/View\Manager\index.html" */ ?>
<?php /*%%SmartyHeaderCode:1493955f83e828e4979-99627125%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '18c66faba187b0908475e039668eb9d92812fb16' => 
    array (
      0 => 'D:/itcast/homework/TPframework/blog/Admin/View\\Manager\\index.html',
      1 => 1444577168,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1493955f83e828e4979-99627125',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_55f83e82c73d7',
  'variables' => 
  array (
    'name' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_55f83e82c73d7')) {function content_55f83e82c73d7($_smarty_tpl) {?><!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<link href="/blog/admin/public/skin/skin.css" rel="stylesheet" type="text/css" id="skin" />
...
<header class="Hui-header cl"> <a class="Hui-logo l" title="H-ui.admin v2.3" href="/">H-ui.admin</a> <a class="Hui-logo-m l" href="/" title="H-ui.admin">H-ui</a> <span class="Hui-subtitle l">V2.3</span>
	...
	<ul class="Hui-userbar">
		<li>管理员</li>
		<li class="dropDown dropDown_hover"><a href="#" class="dropDown_A"><?php echo $_smarty_tpl->tpl_vars['name']->value;?>
...
/Blog/index" href="javascript:void(0)">博文管理</a></li>
				</ul>
				<ul>
					<li><a _href="<?php echo @__MODULE__;?>
/Blog/manus" href="javascript:void(0)">博文草稿</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-picture">
			...
			<dd>
				<ul>
					<li><a _href="<?php echo @__MODULE__;?>
/Picture/index" href="javascript:void(0)">图片管理</a></li>
				</ul>
			</dd>
		</dl>
<!-- 		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li><a _href="<?php echo @__MODULE__;?>
/Category/index" href="javascript:void(0)">分类管理</a></li>
				</ul>
			</dd>
		</dl> -->
		<!--<dl id="menu-page">
		...
		<dl id="menu-comments">
			...
			<dd>
				<ul>
					<li><a _href="<?php echo @__MODULE__;?>
/comment/index" href="javascript:;">评论列表</a></li>
					<li><a _href="<?php echo @__MODULE__;?>
/comment/approve" href="javascript:void(0)">评论审核</a></li>
				</ul>
			</dd>
		</dl>
		<!--<dl id="menu-order">
		...
		<dl id="menu-member">
			<dt><i class="Hui-iconfont">&#xe60d;</i> 评论用户管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a _href="<?php echo @__MODULE__;?>
/User/index" href="javascript:;">用户列表</a></li>
					<li><a _href="<?php echo @__MODULE__;?>
/User/approve" href="javascript:;">用户审核</a></li>
				</ul>
			</dd>
		</dl> 
		<dl id="menu-admin">
			<dt><i class="Hui-iconfont">&#xe62d;</i> 主人管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a _href="<?php echo @__MODULE__;?>
/host/index" href="javascript:void(0)">主人信息</a></li>
					<li><a _href="<?php echo @__MODULE__;?>
/event/index" href="javascript:void(0)">主人大事记</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-tongji">
...
/welcome.html">我的桌面</span><em></em></li>
			</ul>
		</div>
