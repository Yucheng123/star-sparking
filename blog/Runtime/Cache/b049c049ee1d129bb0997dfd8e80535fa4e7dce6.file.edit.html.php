<?php /* Smarty version Smarty-3.1.6, created on 2015-10-01 15:13:48
         compiled from "D:/itcast/homework/TPframework/blog/Admin/View\Event\edit.html" */ ?>
<?php /*%%SmartyHeaderCode:26188560cd84124f505-31880307%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b049c049ee1d129bb0997dfd8e80535fa4e7dce6' => 
    array (
      0 => 'D:/itcast/homework/TPframework/blog/Admin/View\\Event\\edit.html',
      1 => 1443683622,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '26188560cd84124f505-31880307',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_560cd841d513f',
  'variables' => 
  array (
    'cat_parent_infor' => 0,
    'v' => 0,
...
<?php if ($_valid && !is_callable('content_560cd841d513f')) {function content_560cd841d513f($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'D:\\itcast\\homework\\TPframework\\ThinkPHP\\Library\\Vendor\\Smarty\\plugins\\modifier.date_format.php';
?><!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<!-- 		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-2">事件标题：</label>
			<div class="formControls col-2">
				<input type="text" class="input-text" value="<?php echo $_smarty_tpl->tpl_vars['infor']->value['evt_title'];?>
" placeholder="" id="" name="evt_title">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<label class="form-label col-2">事件日期：</label>
			<div class="formControls col-2">
			<input type="text" id="logmax" class="input-text Wdate" name="evt_time" style="width:180px;"  value='<?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['infor']->value['evt_time'],"%Y-%m-%d");?>
'>
			</div>
		</div>
<!-- 		<div class="row cl">
				...
				<div class="uploader-thum-container">
					<div id="fileDrag" class="uploader-Drag">
							<div id="fileList" class="uploader-list">
								<?php if (!empty($_smarty_tpl->tpl_vars['infor']->value['evt_img'])){?>
									已经上传图片，如果继续上传将覆盖原图片
								<?php }?>
							</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-10"> 
				<script id="editor" type="text/plain" style="width:100%;height:400px;" name = "evt_desc"><?php echo $_smarty_tpl->tpl_vars['infor']->value['evt_desc'];?>
</script> 
			</div>
		</div>
		<div class="row cl">
...
/uploadimg',
    ...
    if (!response) {
     ...
     uploader.on( 'uploadSuccess', function( file, response ) {
     	//alert (response.path);
     	var $hide =$(
     				 '<input type="hidden" value="'+response.path+'" name ="evt_img">'
     				); 
     	$list.append($hide);
	});
